...
from api.config import DB_HOST, DB_NAME, DB_PASS, DB_USER, DB_PORT
from api.auth.models import Base as base_auth
...
config.set_section_option(section, "DB_PORT", "5435")
